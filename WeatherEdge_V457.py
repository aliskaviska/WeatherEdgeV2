...
with st.sidebar:
    ...
    with st.expander("Adjust Top Bet filters", expanded=False):
        ...
        min_market_price_pct = st.slider(
            ...
            help=(
                ...
                "this percentage. Higher values are more conservative and filter "
                "out more low-probability outliers."
            ),
        )
    ...
    st.caption(
        ...
        "market probability is adjustable above; increasing it filters out more "
        "low-priced/outlier contracts. Top Bets also require enough historical "
...
def contract_status(row):
    ...
    if float(row.get("ask", 0.0) or 0.0) <= min_market_price:
        reasons.append(
            f"Kalshi market probability is at or below "
