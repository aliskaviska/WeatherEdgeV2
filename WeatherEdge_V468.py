...
st.markdown(
    ...
    <div class="we-hero">
      ...
      <div class="we-tag">Weather intelligence from Earth + orbit</div>
      <div class="we-sub">Calibrated forecasts and live weather markets, without the cockpit clutter.</div>
      <div class="we-satellite-badge">
        <span class="live"></span><span class="sat">🛰️</span> satellite-linked weather intelligence
      </div>
    </div>
    <div class="we-mission-strip">
      <div class="we-mission-item">
        <div class="we-mission-icon">🛰️</div>
        <div><div class="we-mission-title">Satellite weather</div><div class="we-mission-sub">Orbital context for surface conditions</div></div>
      </div>
      <div class="we-mission-item">
        <div class="we-mission-icon">🌡️</div>
        <div><div class="we-mission-title">NWS + observations</div><div class="we-mission-sub">Forecasts grounded by live measurements</div></div>
      </div>
      <div class="we-mission-item">
        <div class="we-mission-icon">◇</div>
        <div><div class="we-mission-title">Probability engine</div><div class="we-mission-sub">Calibrated distributions for market decisions</div></div>
      </div>
    </div>
    """,
    unsafe_allow_html=True,
...
st.markdown(
    """
    <div class="we-weather-dock">
      <div class="we-weather-dock-copy">Earth weather · observed from the ground and from orbit</div>
      <div class="we-weather-dock-icons">
        <span>☀️</span><span>☁️</span><span>🌧️</span><span>⚡</span><span>❄️</span><span>🌬️</span><span>🌴</span><span>🛰️</span>
      </div>
    </div>
    """,
    unsafe_allow_html=True,
