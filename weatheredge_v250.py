...
<div class="we-section-sub">Sorted by model/market gap (high to low) • Blue band = GFS 80% range • Green marker = projected daily high</div>
""", unsafe_allow_html=True)
...
for rank, (_, r) in enumerate(qualified.iterrows(), start=1):
    expander_label = (
        ...
        f"{r['side']} {r['market_subtitle']}  •  edge {fmt_pct(r['edge'])}"
    )
    with st.expander(expander_label, expanded=(rank == 1)):
        ...
        observed_link_html = (
            ...
            <div class="we-sourcebox obs">
              ...
              <div class="we-sourcehelp">Station {r.get('station_id')}: NWS observations are filtered to this contract’s local calendar date before the observed high is calculated.</div>
            </div>
            """
        ...
        st.markdown(
            ...
            <div class="we-sourcegrid">
              <div class="we-sourcebox forecast">
                <a href="{nws_url}" target="_blank">🌤️ Open NWS hourly forecast ↗</a>
                <div class="we-sourcehelp">Only remaining forecast hours belonging to this contract’s local calendar date are used.</div>
              </div>
              {observed_link_html}
            </div>
            """,
        ...
        st.markdown(
            ...
            <div class="we-metricgrid">
              ...
              <div class="we-metric">
                <div class="we-metric-icon">🏷️</div>
                <div class="we-metric-label">Kalshi Live Ask</div>
        ...
        st.markdown(
            f"""
            <div class="we-bookgrid">
              <div class="we-bookcell">
                <div class="we-booklabel">Best Bid</div>
                <div class="we-bookvalue">{bid_txt}</div>
                <div class="we-booknote">What sellers can currently hit</div>
              </div>
              <div class="we-bookcell">
                <div class="we-booklabel">Best Ask</div>
                <div class="we-bookvalue">{price_txt}</div>
                <div class="we-booknote">Your current buy price</div>
              </div>
              <div class="we-bookcell">
                <div class="we-booklabel">Bid–Ask Spread</div>
                <div class="we-bookvalue">{spread_txt}</div>
                <div class="we-booknote">Midpoint {mid_txt}</div>
              </div>
              <div class="we-bookcell">
                <div class="we-booklabel">Liquidity</div>
                <div class="we-bookvalue {liquidity_class}">{liquidity_label}</div>
                <div class="we-booknote">{ask_size_txt} at best ask • {depth_txt} within 5¢</div>
              </div>
            </div>
            """,
            unsafe_allow_html=True,
        ...
        # Visual comparison strip with labeled degree ticks.
        ...
        if low_v is not None and high_v is not None:
            ...
            # Round the visible axis outward and prefer a simple 1°F tick scale.
            ...
            st.markdown(
                ...
                <div class="we-range-card">
                  <div class="we-range-head">
                    <div class="we-range-title">GFS forecast range</div>
                    <div class="we-range-spread">80% range: {low_v:.1f}–{high_v:.1f}°F • width {spread:.1f}°</div>
                  </div>
                  ...
                  <div class="we-range-legend" style="margin-top:.85rem;">
                    <span><i class="we-dot band"></i>Blue = middle 80% of GFS runs</span>
                    <span><i class="we-dot median"></i>GFS = ensemble median</span>
                    <span><i class="we-dot nws"></i>Proj = projected daily high</span>
                    <span><i class="we-dot obs"></i>Obs = observed high</span>
                  </div>
                </div>
                """,
                unsafe_allow_html=True,
        ...
        st.caption(
            f"📅 Date lock: every weather input on this card is restricted to {r['date_label']} "
        ...
        st.markdown(
            ...
            <div class="we-probgrid">
              ...
              <div class="we-probbox">
                ...
                <div class="we-warning">Edge uses the executable best ask, not a midpoint</div>
              </div>
            </div>
            """,
            unsafe_allow_html=True,
        ...
        st.caption(
            ...
            f"Conservative chance: {fmt_pct(r['conservative_prob'])} • "
            f"Kalshi bid/ask: {bid_txt}/{price_txt} • Spread: {spread_txt} • Liquidity: {liquidity_label}"
        )
        ...
        st.markdown(
            ...
            <div class="we-recommend">
              ...
              <div class="we-recommend-note">Kalshi live ask: {price_txt} • Model chance: {fmt_pct(r['model_prob'])}</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
