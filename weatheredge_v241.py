...
st.markdown("""
<div class="we-topbar">
  <div class="we-badge">⚡ WEATHEREDGE v2.4.1 • FORECAST + OBS LINKS</div>
    ...
    with st.container(border=True):
        ...
        observed_link_html = (
            ...
            <div class="we-sourcebox obs">
              ...
              <div class="we-sourcehelp">Station {r.get('station_id')}: recent NWS observations used for the observed high.</div>
            </div>
            """
        ...
        st.markdown(
            ...
            <div class="we-sourcegrid">
              <div class="we-sourcebox forecast">
                ...
                <div class="we-sourcehelp">Remaining hourly forecast used in the projected daily high.</div>
              </div>
              {observed_link_html}
            </div>
            """,
