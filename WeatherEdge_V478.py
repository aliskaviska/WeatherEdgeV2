...
/* Kill V478's extra top-of-page modules even if stale markup survives. */
.we-mission-strip,
.we-weather-dock,
...
st.markdown(
    """
    <div class="we-hero we-hero-clean we-v478-hero">
      <div class="we-v478-copy">
        <div class="we-brand">WEATHEREDGE <span>ORBITAL</span></div>
        <div class="we-v478-edge">PROBABILITY FROM THE EDGE OF SPACE</div>
      </div>
      <div class="we-v478-satellite">🛰️</div>
      <div class="we-v478-sunset"></div>
      <div class="we-v478-palm">🌴</div>
      <div class="we-v478-weather">
...
.we-v478-hero:after {
  ...
  z-index:5 !important;
  background:linear-gradient(90deg,var(--v478-pink),var(--v478-violet),var(--v478-cyan)) !important;
  box-shadow:0 0 12px rgba(255,82,189,.34),0 0 10px rgba(66,220,255,.22) !important;
}
.we-v478-hero > * {position:relative;z-index:3 !important;}
.we-v478-copy {max-width:68%;}
.we-v478-hero .we-brand {
...
.we-v478-hero .we-brand span {
  margin-left:.38rem !important;
  font-size:.64rem !important;
  letter-spacing:.14em !important;
  color:var(--v478-pink) !important;
}
.we-v478-edge {
  margin-top:.55rem;
...
.quality-value {color:var(--v478-pink) !important;}
.quality-grade {color:var(--v478-cyan) !important;}
...
h2:after {
  ...
  margin-top:.28rem;
  border-radius:99px;
  background:linear-gradient(90deg,var(--v478-pink),var(--v478-cyan));
  opacity:.65;
}
...
# V478 visual refinement: slightly larger premium masthead, with all accidental
...
/* Explicitly remove old V468/V478 decorative text-bearing layers that can
...
.we-v478-sub { display:none !important; }
