...
st.markdown("""
<div class="we-topbar">
  <div class="we-badge">⚡ WEATHEREDGE v2.3.1 • CHICAGO = MIDWAY</div>
        ...
        st.markdown(
            ...
            <div class="we-nwsbox">
              ...
              <div style="color:#a9b7c5;font-size:.82rem;margin-top:.35rem;">
                This is the NWS page used to verify the hourly temperatures behind today’s predicted high.
              </div>
            </div>
            """,
            unsafe_allow_html=True,
        ...
        st.markdown(
            ...
            <div class="we-metricgrid">
              <div class="we-metric">
                ...
                <div class="we-metric-label">NWS Predicted High</div>
