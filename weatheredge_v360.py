...
<div class="we-hero">
  <div class="we-cosmic-system">
    <div class="we-orbit"></div>
    <div class="we-orbit-2"></div>
    <div class="we-ring-back"></div>
    <div class="we-cosmic-planet"></div>
    <div class="we-ring-front"></div>
  </div>
  <div class="we-weather-icons">
    <span class="we-weather-icon sun">☀︎</span>
    <span class="we-weather-icon cloud">☁︎</span>
    <span class="we-weather-icon snow">❄︎</span>
    <span class="we-weather-icon rain">☂︎</span>
    <span class="we-weather-icon bolt">↯</span>
    <span class="we-weather-icon wind">≋</span>
  </div>
  <div class="we-hero-palm left">🌴</div>
  <div class="we-hero-palm right">🌴</div>
