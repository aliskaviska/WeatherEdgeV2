...
@media (max-width:760px) {
    .we-coregrid { grid-template-columns:1fr; }
...
for rank, (_, r) in enumerate(qualified.iterrows(), start=1):
    expander_label = (
        ...
        f"{r['side']} on {r['market_subtitle']}  |  Gap {r['conservative_edge']*100:+.1f} pp"
    )
    ...
    with st.expander(expander_label, expanded=False):
        ...
        st.markdown(
            ...
            <div class="we-coregrid">
              ...
              <div class="we-core">
                <div class="we-core-label">GFS Likely Range</div>
                <div class="we-core-value" style="font-size:1.3rem;">{range_txt}</div>
                <div class="we-core-sub">Median {med_txt}</div>
              </div>
              <div class="we-core">
