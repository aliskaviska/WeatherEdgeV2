...
/* Kill V472's extra top-of-page modules even if stale markup survives. */
.we-mission-strip,
.we-weather-dock,
...
st.markdown(
    """
    <div class="we-hero we-hero-clean we-v472-hero">
      <div class="we-v472-copy">
        <div class="we-brand">WEATHEREDGE <span>ORBITAL</span></div>
        <div class="we-v472-edge">PROBABILITY FROM THE EDGE OF SPACE</div>
      </div>
      <div class="we-v472-satellite">🛰️</div>
      <div class="we-v472-sunset"></div>
      <div class="we-v472-palm">🌴</div>
      <div class="we-v472-weather">
...
.we-v472-hero:after {
  ...
  z-index:5 !important;
  background:linear-gradient(90deg,var(--v472-pink),var(--v472-violet),var(--v472-cyan)) !important;
  box-shadow:0 0 12px rgba(255,82,189,.34),0 0 10px rgba(66,220,255,.22) !important;
}
.we-v472-hero > * {position:relative;z-index:3 !important;}
.we-v472-copy {max-width:68%;}
.we-v472-hero .we-brand {
...
.we-v472-hero .we-brand span {
  margin-left:.38rem !important;
  font-size:.64rem !important;
  letter-spacing:.14em !important;
  color:var(--v472-pink) !important;
}
.we-v472-edge {
  margin-top:.55rem;
...
.quality-value {color:var(--v472-pink) !important;}
.quality-grade {color:var(--v472-cyan) !important;}
...
h2:after {
  ...
  margin-top:.28rem;
  border-radius:99px;
  background:linear-gradient(90deg,var(--v472-pink),var(--v472-cyan));
  opacity:.65;
}
...
# V472 visual refinement: slightly larger premium masthead, with all accidental
...
/* Explicitly remove old V468/V472 decorative text-bearing layers that can
...
.we-v472-sub { display:none !important; }
...
top_bet_failure_counts, closest_top_bet_misses = build_top_bet_diagnostics(df)
...
if main_view == "Best Bets":
    ...
    if qualified.empty:
        st.info(
            "No candidates currently pass every Top Bet safety filter. "
            "WeatherEdge is keeping the safety rules intact rather than silently "
            "loosening them."
        )
