...
/* Kill V477's extra top-of-page modules even if stale markup survives. */
.we-mission-strip,
.we-weather-dock,
...
st.markdown(
    """
    <div class="we-hero we-hero-clean we-v477-hero">
      <div class="we-v477-copy">
        <div class="we-brand">WEATHEREDGE <span>ORBITAL</span></div>
        <div class="we-v477-edge">PROBABILITY FROM THE EDGE OF SPACE</div>
      </div>
      <div class="we-v477-satellite">🛰️</div>
      <div class="we-v477-sunset"></div>
      <div class="we-v477-palm">🌴</div>
      <div class="we-v477-weather">
...
.we-v477-hero:after {
  ...
  z-index:5 !important;
  background:linear-gradient(90deg,var(--v477-pink),var(--v477-violet),var(--v477-cyan)) !important;
  box-shadow:0 0 12px rgba(255,82,189,.34),0 0 10px rgba(66,220,255,.22) !important;
}
.we-v477-hero > * {position:relative;z-index:3 !important;}
.we-v477-copy {max-width:68%;}
.we-v477-hero .we-brand {
...
.we-v477-hero .we-brand span {
  margin-left:.38rem !important;
  font-size:.64rem !important;
  letter-spacing:.14em !important;
  color:var(--v477-pink) !important;
}
.we-v477-edge {
  margin-top:.55rem;
...
.quality-value {color:var(--v477-pink) !important;}
.quality-grade {color:var(--v477-cyan) !important;}
...
h2:after {
  ...
  margin-top:.28rem;
  border-radius:99px;
  background:linear-gradient(90deg,var(--v477-pink),var(--v477-cyan));
  opacity:.65;
}
...
# V477 visual refinement: slightly larger premium masthead, with all accidental
...
/* Explicitly remove old V468/V477 decorative text-bearing layers that can
...
.we-v477-sub { display:none !important; }
