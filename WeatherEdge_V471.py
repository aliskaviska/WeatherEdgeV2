...
/* Kill V471's extra top-of-page modules even if stale markup survives. */
.we-mission-strip,
.we-weather-dock,
...
st.markdown(
    """
    <div class="we-hero we-hero-clean we-v471-hero">
      <div class="we-v471-copy">
        <div class="we-brand">WEATHEREDGE <span>ORBITAL</span></div>
        <div class="we-v471-edge">PROBABILITY FROM THE EDGE OF SPACE</div>
        <div class="we-v471-sub">Weather markets · ground truth · orbital context</div>
      </div>
      <div class="we-v471-satellite">🛰️</div>
      <div class="we-v471-sunset"></div>
      <div class="we-v471-palm">🌴</div>
      <div class="we-v471-weather">
...
.we-v471-hero:after {
  ...
  z-index:5 !important;
  background:linear-gradient(90deg,var(--v471-pink),var(--v471-violet),var(--v471-cyan)) !important;
  box-shadow:0 0 12px rgba(255,82,189,.34),0 0 10px rgba(66,220,255,.22) !important;
}
.we-v471-hero > * {position:relative;z-index:3 !important;}
.we-v471-copy {max-width:68%;}
.we-v471-hero .we-brand {
...
.we-v471-hero .we-brand span {
  margin-left:.38rem !important;
  font-size:.64rem !important;
  letter-spacing:.14em !important;
  color:var(--v471-pink) !important;
}
.we-v471-edge {
  margin-top:.55rem;
...
.quality-value {color:var(--v471-pink) !important;}
.quality-grade {color:var(--v471-cyan) !important;}
...
h2:after {
  ...
  margin-top:.28rem;
  border-radius:99px;
  background:linear-gradient(90deg,var(--v471-pink),var(--v471-cyan));
  opacity:.65;
}
...
# V471 visual refinement: slightly larger premium masthead, with all accidental
...
/* Explicitly remove old V468/V471 decorative text-bearing layers that can
