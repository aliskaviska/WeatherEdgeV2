...
/* Kill V470's extra top-of-page modules even if stale markup survives. */
.we-mission-strip,
.we-weather-dock,
...
st.markdown(
    """
    <div class="we-hero we-hero-clean">
      <div class="we-brand">WEATHEREDGE <span>ORBITAL</span></div>
      <div class="we-tag">Weather markets · ground truth · orbital context</div>
      <div class="we-mini-status"><span></span> LIVE</div>
    </div>
    """,
    unsafe_allow_html=True,
)
...
# V470 visual refinement: slightly larger premium masthead, with all accidental
...
/* Explicitly remove old V468/V470 decorative text-bearing layers that can
